...
const performRequest_1 = require("../../src/performRequest");
...
describe('performRequest', () => {
    ...
    describe('auto retry', () => {
        ...
        it('should only auto retry google error once (Server encountered an error)', () => __awaiter(void 0, void 0, void 0, function* () {
            mockFetch.mockResolvedValue(getMockResponse({
                ok: false,
                status: 500,
                text: () => '\n<html><head>\n<meta http-equiv="content-type" content="text/html;charset=utf-8">\n<title>500 Server Error</title>\n</head>\n<body text=#000000 bgcolor=#ffffff>\n<h1>Error: Server Error</h1>\n<h2>The server encountered an error and could not complete your request.<p>Please try again in 30 seconds.</h2>\n<h2></h2>\n</body></html>\n',
        ...
        it('should only auto retry google error once (Temporary error)', () => __awaiter(void 0, void 0, void 0, function* () {
            mockFetch.mockResolvedValue(getMockResponse({
                ok: false,
                status: 500,
        ...
        it('should only auto retry google error once (Service not available)', () => __awaiter(void 0, void 0, void 0, function* () {
            mockFetch.mockResolvedValue(getMockResponse({
                ok: false,
                status: 500,
    ...
    describe('getContent', () => {
        test('Returns undefined if status 204', () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield (0, performRequest_1.getContent)({
                status: 204,
            })).toEqual(undefined);
        }));
        test('Returns undefined if content-length === 0', () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield (0, performRequest_1.getContent)({
                headers: {
                    get: () => '0',
                },
        ...
        test('Returns 1st arg if res-type === response', () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield (0, performRequest_1.getContent)('woo', 'response')).toEqual('woo');
        }));
        test('Returns json if resType not given and not undefined', () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield (0, performRequest_1.getContent)({
                json: () => 'woo',
                headers: {
                    get: jest.fn(),
        ...
        test('Returns res.resType if resType given and not undefined', () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield (0, performRequest_1.getContent)({
                woo: () => 'yay',
                headers: {
                    get: jest.fn(),
...
//# sourceMappingURL=performRequest.test.js.map